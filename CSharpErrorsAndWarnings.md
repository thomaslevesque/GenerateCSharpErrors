...
|[CS0206](https://docs.microsoft.com/en-us/dotnet/csharp/misc/cs0206)|Error|A non ref-returning property or indexer may not be used as an out or ref value|
...
|[CS0231](https://docs.microsoft.com/en-us/dotnet/csharp/misc/cs0231)|Error|A params parameter must be the last parameter in a parameter list|
...
|[CS0767](https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/compiler-messages/cs0767)|Error|Cannot inherit interface '{0}' with the specified type parameters because it causes method '{1}' to contain overloads which differ only on ref and out|
...
|[CS0846](https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/compiler-messages/cs0846)|Error|A nested array initializer is expected|
...
|[CS0854](https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/compiler-messages/cs0854)|Error|An expression tree may not contain a call or invocation that uses optional arguments|
...
|[CS1063](https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/compiler-messages/cs1063)|Error|The best overloaded Add method '{0}' for the collection initializer element is obsolete. {1}|
...
|[CS1626](https://docs.microsoft.com/en-us/dotnet/csharp/misc/cs1626)|Error|Cannot yield a value in the body of a try block with a catch clause|
...
|[CS1739](https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/compiler-messages/cs1739)|Error|The best overload for '{0}' does not have a parameter named '{1}'|
|[CS1740](https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/compiler-messages/cs1740)|Error|Named argument '{0}' cannot be specified multiple times|
|[CS1741](https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/compiler-messages/cs1741)|Error|A ref or out parameter cannot have a default value|
|[CS1742](https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/compiler-messages/cs1742)|Error|An array access may not have a named argument specifier|
...
|[CS1751](https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/compiler-messages/cs1751)|Error|Cannot specify a default value for a parameter array|
...
|[CS1950](https://docs.microsoft.com/en-us/dotnet/csharp/misc/cs1950)|Error|The best overloaded Add method '{0}' for the collection initializer has some invalid arguments|
|[CS1951](https://docs.microsoft.com/en-us/dotnet/csharp/misc/cs1951)|Error|An expression tree lambda may not contain a ref, in or out parameter|
...
|[CS1988](https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/compiler-messages/cs1988)|Error|Async methods cannot have ref, in or out parameters|
...
|[CS3016](https://docs.microsoft.com/en-us/dotnet/csharp/misc/cs3016)|Warning|Arrays as attribute arguments is not CLS-compliant|
...
|[CS4013](https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/compiler-messages/cs4013)|Error|Instance of type '{0}' cannot be used inside a nested function, query expression, iterator block or async method|
...
|[CS7000](https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/compiler-messages/cs7000)|Error|Unexpected use of an aliased name|
...
|[CS8153](https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/compiler-messages/cs8153)|Error|An expression tree lambda may not contain a call to a method, property, or indexer that returns by reference|
|[CS8154](https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/compiler-messages/cs8154)|Error|The body of '{0}' cannot be an iterator block because '{0}' returns by reference|
|[CS8155](https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/compiler-messages/cs8155)|Error|Lambda expressions that return by reference cannot be converted to expression trees|
...
|[CS8166](https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/compiler-messages/cs8166)|Error|Cannot return a parameter by reference '{0}' because it is not a ref parameter|
|[CS8167](https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/compiler-messages/cs8167)|Error|Cannot return by reference a member of parameter '{0}' because it is not a ref or out parameter|
|[CS8168](https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/compiler-messages/cs8168)|Error|Cannot return local '{0}' by reference because it is not a ref local|
|[CS8169](https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/compiler-messages/cs8169)|Error|Cannot return a member of local '{0}' by reference because it is not a ref local|
...
|[CS8175](https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/compiler-messages/cs8175)|Error|Cannot use ref local '{0}' inside an anonymous method, lambda expression, or query expression|
|[CS8176](https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/compiler-messages/cs8176)|Error|Iterators cannot have by-reference locals|
|[CS8177](https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/compiler-messages/cs8177)|Error|Async methods cannot have by-reference locals|
|[CS8178](https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/compiler-messages/cs8178)|Error|'await' cannot be used in an expression containing a call to '{0}' because it returns by reference|
...
|[CS8373](https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/compiler-messages/cs8373)|Error|The left-hand side of a ref assignment must be a ref variable.|
|[CS8374](https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/compiler-messages/cs8374)|Error|Cannot ref-assign '{1}' to '{0}' because '{1}' has a narrower escape scope than '{0}'.|
...
|[CS9050](https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/compiler-messages/cs9050)|Error|A ref field cannot refer to a ref struct.|
...
|CS9096|Error|Cannot ref-assign '{1}' to '{0}' because '{1}' has a wider value escape scope than '{0}' allowing assignment through '{0}' of values with narrower escapes scopes than '{1}'.|
|CS9097|Warning|This ref-assigns '{1}' to '{0}' but '{1}' has a wider value escape scope than '{0}' allowing assignment through '{0}' of values with narrower escapes scopes than '{1}'.|
...
|CS9101|Error|UnscopedRefAttribute can only be applied to struct instance methods and properties, and cannot be applied to constructors or init-only members.|
|CS9102|Error|UnscopedRefAttribute cannot be applied to an interface implementation.|
|CS9103|Error|'{0}' is defined in a module with an unrecognized RefSafetyRulesAttribute version, expecting '11'.|
|CS9104|Error|A using statement resource of type '{0}' cannot be used in async methods or async lambda expressions.|
